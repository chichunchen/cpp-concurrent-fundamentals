...
#ifndef CONCURRENT_TOOLKITS_CPP_SIMPLEGRAPH_ATOMIC_H
#define CONCURRENT_TOOLKITS_CPP_SIMPLEGRAPH_ATOMIC_H
...
public:
    ...
    int load_file(const char *f) {
        ...
        if (fscanf(fp, "%zu %zu", &num_nodes, &num_edges) == EOF) {
...
typedef SimpleCSRGraph<unsigned int, std::atomic_int> SimpleCSRGraphUII;


#endif //CONCURRENT_TOOLKITS_CPP_SIMPLEGRAPH_ATOMIC_H
